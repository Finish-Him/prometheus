...
# Recipients
RECIPIENTS = ["moises.costa12345@gmail.com", "gabrielol2035@gmail.com"]
        ...
        for match in cls.SCHEDULE:
            ...
            if 0 < hours <= hours_before:
                needing_report.append(
                    {**match, "datetime": match_dt, "hours_until": hours, "countdown": format_countdown(hours)}
                )
...
class EmailNotifier:
    ...
    def send_email(self, to_emails: List[str], subject: str, body_html: str, attachments: List[Dict] = None) -> bool:
    ...
    def send_daily_schedule(self, to_emails: List[str] = None) -> bool:
        ...
        return self.send_email(to_emails, f"🎮 DreamLeague S27 - Partidas {today}", html)

    def send_match_report(
        self, match: Dict, analysis: Dict, pdf_data: bytes = None, to_emails: List[str] = None
    ) -> bool:
