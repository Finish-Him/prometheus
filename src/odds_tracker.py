...
class OddsTracker:
    ...
    # Common bookmakers
    BOOKMAKERS = ["bet365", "Betano", "Betfair", "Pinnacle", "1xBet", "Rivalry", "Thunderpick", "GG.bet", "Stake"]
    ...
    def register_odds(
        ...
        # Add to history
        self.data["history"].append({"match_id": match_id, "bookmaker": bookmaker, **odds_entry})

        self._save_odds()

        return {"success": True, "match_id": match_id, "bookmaker": bookmaker, "odds": odds_entry}
    ...
    def get_best_odds(self, match_id: str) -> Dict:
        ...
        return {"team_a": match["team_a"], "team_b": match["team_b"], "best_odds_a": best_a, "best_odds_b": best_b}
    ...
    def calculate_value(self, match_id: str, predicted_prob_a: float, predicted_prob_b: float = None) -> Dict:
