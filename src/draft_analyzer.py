...
HERO_PROFILES: Dict[str, HeroProfile] = {
    # Carries
    "Faceless Void": HeroProfile(
        "Faceless Void", [Role.CARRY], Attribute.AGILITY, Timing.LATE, 6, 10, 4, 5, 2, 9, "physical", 8
    ),
    "Phantom Assassin": HeroProfile(
        "Phantom Assassin", [Role.CARRY], Attribute.AGILITY, Timing.MID, 7, 6, 5, 8, 1, 2, "physical", 7
    ),
    "Morphling": HeroProfile("Morphling", [Role.CARRY], Attribute.AGILITY, Timing.LATE, 7, 5, 6, 8, 2, 3, "mixed", 9),
    "Terrorblade": HeroProfile(
        "Terrorblade", [Role.CARRY], Attribute.AGILITY, Timing.LATE, 8, 5, 10, 3, 1, 2, "physical", 4
    ),
    ...
    "Juggernaut": HeroProfile(
        "Juggernaut", [Role.CARRY], Attribute.AGILITY, Timing.MID, 7, 6, 7, 7, 3, 2, "physical", 5
    ),
    "Lifestealer": HeroProfile(
        "Lifestealer", [Role.CARRY], Attribute.STRENGTH, Timing.MID, 7, 5, 5, 6, 2, 1, "physical", 6
    ),
    "Slark": HeroProfile("Slark", [Role.CARRY], Attribute.AGILITY, Timing.MID, 6, 4, 4, 9, 4, 3, "physical", 9),
    "Anti-Mage": HeroProfile(
        "Anti-Mage", [Role.CARRY], Attribute.AGILITY, Timing.LATE, 8, 4, 8, 6, 1, 1, "physical", 10
    ),
    "Naga Siren": HeroProfile(
        "Naga Siren", [Role.CARRY], Attribute.AGILITY, Timing.LATE, 9, 6, 10, 4, 3, 5, "physical", 5
    ),
    "Spectre": HeroProfile("Spectre", [Role.CARRY], Attribute.AGILITY, Timing.LATE, 5, 9, 3, 7, 1, 2, "physical", 10),
    "Drow Ranger": HeroProfile(
        "Drow Ranger", [Role.CARRY], Attribute.AGILITY, Timing.MID, 8, 5, 8, 5, 1, 4, "physical", 3
    ),
    # Mids
    "Invoker": HeroProfile("Invoker", [Role.MID], Attribute.UNIVERSAL, Timing.MID, 7, 9, 6, 7, 4, 8, "mixed", 6),
    "Storm Spirit": HeroProfile(
        "Storm Spirit", [Role.MID], Attribute.INTELLIGENCE, Timing.MID, 6, 6, 4, 10, 2, 5, "magical", 10
    ),
    "Queen of Pain": HeroProfile(
        "Queen of Pain", [Role.MID], Attribute.INTELLIGENCE, Timing.MID, 7, 8, 5, 8, 1, 3, "magical", 9
    ),
    "Ember Spirit": HeroProfile(
        "Ember Spirit", [Role.MID], Attribute.AGILITY, Timing.MID, 6, 7, 4, 8, 3, 4, "mixed", 9
    ),
    "Leshrac": HeroProfile("Leshrac", [Role.MID], Attribute.INTELLIGENCE, Timing.MID, 8, 8, 10, 4, 1, 5, "magical", 5),
    "Templar Assassin": HeroProfile(
        "Templar Assassin", [Role.MID], Attribute.AGILITY, Timing.MID, 7, 5, 8, 7, 1, 2, "physical", 6
    ),
    "Shadow Fiend": HeroProfile(
        "Shadow Fiend", [Role.MID], Attribute.AGILITY, Timing.MID, 8, 7, 7, 5, 1, 3, "mixed", 4
    ),
    "Puck": HeroProfile(
        "Puck", [Role.MID, Role.OFFLANE], Attribute.INTELLIGENCE, Timing.MID, 6, 8, 4, 7, 3, 7, "magical", 9
    ),
    "Void Spirit": HeroProfile(
        "Void Spirit", [Role.MID], Attribute.UNIVERSAL, Timing.MID, 6, 7, 4, 9, 3, 5, "magical", 10
    ),
    "Lina": HeroProfile(
        "Lina", [Role.MID, Role.SOFT_SUPPORT], Attribute.INTELLIGENCE, Timing.MID, 7, 7, 6, 6, 1, 4, "magical", 4
    ),
    "Kunkka": HeroProfile(
        "Kunkka", [Role.MID, Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 7, 9, 5, 6, 2, 7, "physical", 5
    ),
    # Offlaners
    ...
    "Legion Commander": HeroProfile(
        "Legion Commander", [Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 7, 5, 5, 8, 3, 4, "physical", 6
    ),
    "Tidehunter": HeroProfile(
        "Tidehunter", [Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 8, 10, 5, 3, 2, 9, "magical", 4
    ),
    "Centaur Warrunner": HeroProfile(
        "Centaur Warrunner", [Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 8, 8, 5, 5, 4, 6, "mixed", 7
    ),
    "Enigma": HeroProfile(
        "Enigma", [Role.OFFLANE], Attribute.INTELLIGENCE, Timing.MID, 7, 10, 8, 4, 2, 9, "magical", 4
    ),
    "Sand King": HeroProfile(
        "Sand King", [Role.OFFLANE, Role.SOFT_SUPPORT], Attribute.STRENGTH, Timing.MID, 7, 9, 4, 4, 2, 8, "magical", 7
    ),
    "Beastmaster": HeroProfile(
        "Beastmaster", [Role.OFFLANE], Attribute.UNIVERSAL, Timing.EARLY, 8, 7, 9, 6, 2, 6, "mixed", 5
    ),
    "Primal Beast": HeroProfile(
        "Primal Beast", [Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 8, 9, 4, 6, 2, 8, "physical", 6
    ),
    "Doom": HeroProfile("Doom", [Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 7, 6, 5, 7, 1, 8, "mixed", 5),
    "Pangolier": HeroProfile(
        "Pangolier", [Role.OFFLANE, Role.MID], Attribute.UNIVERSAL, Timing.MID, 7, 8, 4, 7, 3, 7, "physical", 9
    ),
    # Supports
    "Crystal Maiden": HeroProfile(
        "Crystal Maiden", [Role.HARD_SUPPORT], Attribute.INTELLIGENCE, Timing.EARLY, 6, 8, 3, 3, 2, 7, "magical", 2
    ),
    "Lion": HeroProfile(
        "Lion",
        [Role.HARD_SUPPORT, Role.SOFT_SUPPORT],
    ...
    "Witch Doctor": HeroProfile(
        "Witch Doctor", [Role.HARD_SUPPORT], Attribute.INTELLIGENCE, Timing.MID, 6, 8, 4, 4, 3, 5, "magical", 3
    ),
    "Dazzle": HeroProfile(
        "Dazzle", [Role.HARD_SUPPORT], Attribute.INTELLIGENCE, Timing.MID, 7, 6, 5, 3, 10, 4, "physical", 3
    ),
    "Oracle": HeroProfile(
        "Oracle", [Role.HARD_SUPPORT], Attribute.INTELLIGENCE, Timing.MID, 6, 5, 3, 4, 10, 6, "magical", 3
    ),
    "Chen": HeroProfile(
        "Chen", [Role.HARD_SUPPORT], Attribute.INTELLIGENCE, Timing.EARLY, 8, 6, 9, 3, 8, 6, "mixed", 4
    ),
    "Io": HeroProfile("Io", [Role.HARD_SUPPORT], Attribute.STRENGTH, Timing.MID, 6, 7, 5, 3, 10, 2, "magical", 8),
    "Treant Protector": HeroProfile(
        "Treant Protector", [Role.HARD_SUPPORT], Attribute.STRENGTH, Timing.MID, 7, 8, 6, 3, 9, 6, "physical", 3
    ),
    "Undying": HeroProfile(
        "Undying", [Role.HARD_SUPPORT, Role.OFFLANE], Attribute.STRENGTH, Timing.EARLY, 9, 8, 5, 3, 3, 5, "physical", 3
    ),
    # Soft Supports
    "Earth Spirit": HeroProfile(
        "Earth Spirit", [Role.SOFT_SUPPORT], Attribute.STRENGTH, Timing.EARLY, 7, 7, 3, 7, 4, 9, "magical", 9
    ),
    "Tusk": HeroProfile("Tusk", [Role.SOFT_SUPPORT], Attribute.STRENGTH, Timing.EARLY, 7, 6, 3, 8, 5, 6, "physical", 7),
    "Rubick": HeroProfile(
        "Rubick", [Role.SOFT_SUPPORT], Attribute.INTELLIGENCE, Timing.MID, 5, 8, 3, 5, 4, 7, "magical", 5
    ),
    "Snapfire": HeroProfile(
        "Snapfire", [Role.SOFT_SUPPORT], Attribute.STRENGTH, Timing.MID, 7, 8, 5, 5, 4, 6, "mixed", 5
    ),
    "Hoodwink": HeroProfile(
        "Hoodwink", [Role.SOFT_SUPPORT], Attribute.AGILITY, Timing.MID, 6, 6, 4, 6, 3, 6, "mixed", 7
    ),
    "Marci": HeroProfile(
        "Marci", [Role.SOFT_SUPPORT, Role.OFFLANE], Attribute.UNIVERSAL, Timing.MID, 7, 7, 4, 8, 4, 6, "physical", 8
    ),
    "Dark Willow": HeroProfile(
        "Dark Willow", [Role.SOFT_SUPPORT], Attribute.INTELLIGENCE, Timing.MID, 6, 8, 3, 6, 3, 8, "magical", 6
    ),
    "Phoenix": HeroProfile(
        "Phoenix", [Role.SOFT_SUPPORT, Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 7, 9, 4, 4, 5, 5, "magical", 6
    ),
    "Elder Titan": HeroProfile(
        "Elder Titan", [Role.SOFT_SUPPORT, Role.OFFLANE], Attribute.STRENGTH, Timing.MID, 7, 9, 4, 4, 3, 8, "mixed", 4
    ),
}
...
class DraftAnalyzer:
    ...
    def analyze_composition(self, picks: List[str]) -> Dict:
        ...
        archetype = self._determine_archetype(avg_teamfight, avg_push, avg_pickoff, avg_control, primary_timing)
    ...
    def _determine_archetype(
        self, teamfight: float, push: float, pickoff: float, control: float, timing: Timing
    ) -> str:
    ...
    def compare_drafts(self, radiant_picks: List[str], dire_picks: List[str]) -> Dict:
        ...
        for metric in ["teamfight", "push", "pickoff", "save", "control", "mobility"]:
            ...
            score_comparison[metric] = {"radiant": r_score, "dire": d_score, "advantage": advantage}
        ...
        return {
            ...
            "win_probability": {"radiant": radiant_prob, "dire": 100 - radiant_prob},
...
def analyze_draft(radiant_picks: List[str], dire_picks: List[str]) -> Dict:
